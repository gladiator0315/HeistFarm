--ALL credits go to Kinlei for making https://raw.githubusercontent.com/Kinlei/Dynissimo/main/Scripts/AkaliNotif.lua
--This is slightly modified to change where notify is
...
Container.Position = UDim2.new(0, 1700, 0.6, -40);
